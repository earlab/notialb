...
//:===================================================================
	...
	SynthDef(\Bota2_Meros_2, {
		...
		Mix.fill(2, {|i| i = i * harm/1; SinOscFB.ar(400 + i, 0.8, 1)}) + Mix.fill(1, {|i| i = i * harm/1; SinOscFB.ar(43 + i, 0, 1)}*0.1);
...
//:	(1) - Standart ========================ALLAGES-La_Dose(Bigger amp in first Bota)
//===========================================================================
...
Pdef(\standart2_Meros_2).quant = 0;
//:	(3) - More_Bota
//===========================================================================
...
Pdef(\more_Bota_Meros_2, Ppar([
	...
	Pbind(
			...
			\ampD, Pseq([0.5, 0.5, 0.5, 0.5, 1.4], inf),
			//Drone Envelope
...
Pdef(\More_Rand_2_Meros_2, Ppar([
	...
	Pbind(
			...
			\fback, Pseq([0, 0.5, 0, 0, 0, 5000], inf), 
			\freq, Pseq([43, 43, 43, 43,[~f_2, ~f_1]/1.5]*1.5, inf),
			\ampD, Pseq([0.5, 0.5, 0.5, 0.5, 0.8], inf),
			//Drone Envelope
			\at, Pseq([1, 1, 1, 1, 5], inf), //def 1
			\rel, Pseq([2, 2, 2, 2, 0.002], inf),//def 3 * 2 and the last 0.02
			\shape, Pseq([-4, -4, -4, -4, 1], inf),//def -4
	...
	Pbind(
			\instrument, \Bota2_Meros_2,
			//All
			\dur, Pseq([1, 1/2, 3/4, 3/4, 3/4, 3/4, 1/2], 1),
			\harm, Pseq([1, 1, 1, 1], inf),
			\ampB, Pseq([0.2, 0.1, 0.1, 0.1], inf),
			//Bota Envelope
			\at, Pseq([0.01, 0.01, 0.01, 0.01], inf), //def 1
...
Pdef(\More_Rand_2_Meros_2).quant = 0;
//Pdef(\More_Rand_2_Meros_2).play;
...
Pdef(\arxi_Meros_2, Ppar([
	...
	Pbind(
			...
			\harm, Pseq([1], inf),
			//Drone
			\fback, Pseq([[5000, 0]], inf), 
			\freq, Pseq([[~f_2/1.5, 20]]*1.5, inf),
			\ampD, Pseq([0.6], inf),
			//Drone Envelope
			\at, Pseq([16], inf), //def 1
			\rel, Pseq([0.02], inf),//def 3 * 2 and the last 0.02
			\shape, Pseq([-1], inf),//def -4
			),
	...
	Pbind(
			...
			\att, Pseq([16], inf),
			\dect, Pseq([2]/1, inf),
			\relt, Pseq([5], inf),  //def 0.1
			
			//Maxi Envelope Shape
			\at, Pseq([16]/100, inf),
			\dec, Pseq([0.2]/100, inf),
			\ss, Pseq([2], inf),
...
/*			
	...
	Pbind(
			...
			\dur, Pseq([1, 1/2, 3/2, 1], 1),
			\harm, Pseq([1, 1, 1, 1], inf),
			\ampB, Pseq([0.1, 0.1, 0.1, 0.1]*0, inf),
			//Bota Envelope
			\at, Pseq([0.01, 0.01, 0.01, 0.01], inf), //def 1
			\rel, Pseq([0.2, 0.2, 0.2, 0.2], inf),//def 3 * 2 and the last 0.02
			\shape, Pseq([-200, -200, -200, -200], inf),//def -4
...
Pdef(\arxi_Meros_2).quant = 0;
//Pdef(\arxi_Meros_2).play;
